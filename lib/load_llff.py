...
def load_llff_data(basedir, factor=8, width=None, height=None,
                   ...
                   bd_factor=.75, spherify=False, path_zflat=False, load_depths=False, load_SR=False,
                   movie_render_kwargs={}):

    poses, bds, imgs, *depths = _load_data(basedir, factor=factor, width=width, height=height,
                                           load_depths=load_depths, load_SR=load_SR) # factor=8 downsamples original imgs by 8x
